...
if (event.shiftKey && event.keyCode === 192) {
event.preventDefault();
var labels = document.querySelectorAll("#babanum > label");
...
if (hours == 17) {
 ...
 function renkyp() {
  localStorage.setItem("renkli", -10);
  alert("YURTLUM TR'YE ÖZEL RENK AKTİF EDİLDİ");
  localStorage.removeItem("renk");
  localStorage.setItem("renk", 20);
  
  location.reload();
}

let renkkod = localStorage.getItem("renkod");
